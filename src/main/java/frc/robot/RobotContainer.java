...
import frc.robot.commands.shooter.ShootTrenchCommand;
...
public class RobotContainer {
        ...
        private boolean bDoBounce = true;
        ...
        private void registerAutos() {
                ...
                NamedCommands.registerCommand("StartShooterWheels",
                                Commands.runOnce(shooterSubsystem::setShooterWheelsShoot));
                NamedCommands.registerCommand("StopShooterWheels",
                                Commands.runOnce(shooterSubsystem::stopShooterWheels));
                ...
                NamedCommands.registerCommand("StopCollectAutoCommand",
                                new StartCollectAutoCommand(collectorSubsystem));
                NamedCommands.registerCommand("StartWaitStopCollectionAutoCommand",
        ...
        private void bindDriverCompetitionControls() {
                final Command driveFieldOrientedAngularVelocity = drivebaseSubsystem
